...
CREATE TABLE `users` (
    ...
    `status` ENUM('ACTIVE', 'BLOCKED', 'INACTIVE', 'DELETED') NOT NULL DEFAULT 'ACTIVE',
...
CREATE TABLE `tokens` (
    ...
    INDEX `tokens_token_idx`(`token`(191)),
    INDEX `tokens_user_id_type_idx`(`user_id`, `type`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `user_verifications` (
    ...
    INDEX `user_verifications_verificationStatus_idx`(`verificationStatus`),
    INDEX `user_verifications_created_at_idx`(`created_at`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `products` (
    ...
    `status` ENUM('ACTIVE', 'DRAFT', 'INACTIVE', 'BLOCKED', 'OUT_OF_STOCK', 'DELETED') NOT NULL DEFAULT 'ACTIVE',
    ...
    INDEX `products_province_regency_idx`(`province`, `regency`),
...
CREATE TABLE `product_technical_specs` (
    ...
    INDEX `product_technical_specs_product_id_idx`(`product_id`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `orders` (
    ...
    INDEX `orders_seller_id_status_idx`(`seller_id`, `status`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `negotiations` (
    ...
    `status` ENUM('OPEN_NEGOTIATION', 'OFFER_SUBMITTED', 'OFFER_ACCEPTED', 'OFFER_REJECTED', 'EXPIRED', 'LOCKED', 'CANCELLED') NOT NULL DEFAULT 'OPEN_NEGOTIATION',
    ...
    INDEX `negotiations_status_updated_at_idx`(`status`, `updated_at`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `transactions` (
    ...
    INDEX `transactions_external_id_idx`(`external_id`),
    INDEX `transactions_payment_request_id_idx`(`payment_request_id`),
    INDEX `transactions_status_type_idx`(`status`, `type`),
...
CREATE TABLE `iot_devices` (
    ...
    `threshold_min` DECIMAL(15, 2) NULL DEFAULT 200,
    `threshold_max` DECIMAL(15, 2) NULL DEFAULT 600,
    `created_at` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updated_at` DATETIME(3) NOT NULL,
...
CREATE TABLE `iot_alerts` (
    ...
    INDEX `iot_alerts_device_id_is_read_created_at_idx`(`device_id`, `is_read`, `created_at`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `forum_posts` (
    ...
    INDEX `forum_posts_updated_at_idx`(`updated_at`),
    INDEX `forum_posts_status_category_id_idx`(`status`, `category_id`),
    INDEX `forum_posts_status_created_at_idx`(`status`, `created_at`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `forum_comments` (
    ...
    INDEX `forum_comments_parent_id_idx`(`parent_id`),
...
CREATE TABLE `articles` (
    ...
    INDEX `articles_updated_at_idx`(`updated_at`),
    INDEX `articles_status_category_id_idx`(`status`, `category_id`),
...
CREATE TABLE `user_devices` (
    ...
    UNIQUE INDEX `user_devices_fcm_token_key`(`fcm_token`),
...
CREATE TABLE `customer_addresses` (
    ...
    INDEX `customer_addresses_address_id_idx`(`address_id`),
...
CREATE TABLE `platform_fee_settings` (
    `id` VARCHAR(191) NOT NULL,
    `name` ENUM('TRANSACTION_FEE', 'WITHDRAWAL_FEE', 'ADMIN_FEE', 'LOGISTICS_FEE', 'CARBON_FEE', 'BIOMASS_FEE', 'SUBSCRIPTION', 'VAT') NOT NULL,
    `description` TEXT NULL,
